...
def add_letter_to_doc(doc, owner_name, address, zip_code, sale_date, sale_price):
    ...
    # Letter content
    body = (
"Homeowners Insurance Rates Are Dropping – Don’t Miss Out!\n\n"
    "For the first time in years, rates are coming down — and the savings could be significant.\n\n"
    ...
    "Jones Insurance Advisors is a second-generation, family-owned agency right here in Vero Beach. Our local expertise means we can help you find the most comprehensive and competitively priced coverage for your home.\n\n"
    "Call us today for a free, no-obligation quote, or visit our website to request one online. Experience the personal, dedicated service you get when you work with a local agency.\n\n"
    )
